...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Get in touch for commissions, collaborations, or project inquiries.",
};
...
export default function ContactPage() {
  const isOpen = siteConfig.availability === "open";
  return (
    <div className={`container page-content ${styles.page}`}>
      <h1 className={styles.heading}>Contact</h1>

      {/* Availability status */}
      <div className={`${styles.availability} ${isOpen ? styles.availOpen : styles.availClosed}`}>
        <span className={styles.dot} />
        <p>{siteConfig.availabilityMessage}</p>
      </div>
      ...
      <div className={styles.grid}>
        ...
        <div className={styles.infoCol}>
          <p className={styles.emailLabel}>Or email me directly</p>
